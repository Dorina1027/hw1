...
INSERT INTO movies (title, yeat_released, mpaa_rating, studio_id) VALUES ("The Dark Knight", 2008, "PG-13", 1);
...
--Insert roles for Batman Begins, The Dark Knight, The Dark Knight Rise
...
FROM roles
INNER JOIN movie ON roles.movie_id = movies.id
